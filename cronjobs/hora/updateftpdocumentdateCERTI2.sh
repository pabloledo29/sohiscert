...
#/opt/rh/rh-php72/root/usr/bin/php /opt/app-root/src/bin/console appbundle:emaildoccerti:send    
...
tried=0;
total_tried=2
execution_string=/opt/rh/rh-php72/root/usr/bin/php /opt/app-root/src/bin/console email:emaildoccerti2:send &
wait;

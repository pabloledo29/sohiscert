...
#MNN Para mandar tareas de email de cretificados
#/opt/rh/rh-php72/root/usr/bin/php /opt/app-root/src/bin/console appbundle:emaildocfactu:send   
...
tried=0;
total_tried=2
execution_string=/opt/rh/rh-php72/root/usr/bin/php /opt/app-root/src/bin/console email:emaildocfactu3:send &

 ...
 * @ORM\Table(name="gs_tiposproducto")
 * @ORM\Entity(repositoryClass="App\Repository\TiposProductoRepository")
...
class TiposProducto
{
    ...
    /**
     * @ORM\Column(name="tiDeno", type="string", length=255, nullable=true)
     * @JMS\Type("string")
     */
    private $tiDeno;
     ...
     * @return TiposProducto
     */
    public function setTiDeno($tiDeno)
    {
        $this->tiDeno = $tiDeno;

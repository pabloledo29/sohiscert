            ...
            <div id="fondo">
                <div id="contain" class="sombras2">
                    ...
                    <div id="mensaje">
                       ...
                       <p>Para restablecer MAILERPHP su contraseña por favor pinche el siguiente enlace: <a href="{{path(https://intranet-sohiscert4.e4ff.pro-eu-west-1.openshiftapps.com/public/resetting/' . $parameters['confirmationUrl'].')}}">https://intranet-sohiscert4.e4ff.pro-eu-west-1.openshiftapps.com/public/resetting/' . $parameters['confirmationUrl'] .'</a></p> 

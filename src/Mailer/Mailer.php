            ...
            <div id="fondo">
                <div id="contain" class="sombras2">
                    ...
                    <div id="mensaje">
                        ...
                        <p>Para restablecer su contraseña por favor pinche el siguiente enlace: <a href="{{path(https://intranet-sohiscert4.e4ff.pro-eu-west-1.openshiftapps.com/resetting/' . $parameters['confirmationUrl'].')}}">https://intranet-sohiscert4.e4ff.pro-eu-west-1.openshiftapps.com/resetting/' . $parameters['confirmationUrl'] .'</a></p> 

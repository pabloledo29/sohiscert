...
/**
 * Class EmaildoccarSend4Command
 * @package App\Command
 */
class EmaildoccarSend4Command extends Command
{
    protected static $defaultName = 'email:emaildoccar4:send';
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $path_file = $urlBase.'register_recorridos_CARTA4_'.date("d_m_Y").'.log';
        ...
        foreach ($rutasftp as $tipodoc => $ruta) {
           ...
           $numarch = count($lista);
            ...
            for ($i=$numarch_desde; $i <= $numarch ; $i++) {
        ...
        # Definimos la Ruta Completa y el Nombre del Fichero LOG que se va a generar
        $path_file = $urlBase.'update_datedocuments_CARTAS4_'.date("d_m_Y").'.log';
